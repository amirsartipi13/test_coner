...
class Params:
    def __init__(self, train, test, dev,
            model, model_name,
            out_dir='./outs', iob_tagging='wunt', 
            max_instances=-1, max_length=50,
            encoder_model='xlm-roberta-large',
            gz_path='./', freez_epochs=10,
            two_stage=False,
            base_model='NER',
            stage='fit', prefix='test',
            batch_size=16, gpus=1, epochs=3,
            lr=1e-5, dropout=0.3):
        ...
        self.freez_epochs = freez_epochs
